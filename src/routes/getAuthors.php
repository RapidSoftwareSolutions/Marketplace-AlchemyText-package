...
$app->post('/api/AlchemyText/getAuthors', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['html'])) {
        ...
        if(!empty($post_data['args']['urlForResponse'])) {
            $body['url'] = $post_data['args']['urlForResponse'];
        }
        
        $query_str = 'https://gateway-a.watsonplatform.net/calls/html/HTMLGetAuthors?apikey='.$post_data['args']['apiKey'];
    }
