...
$app->post('/api/AlchemyText/getCombinedData', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['url'])) {
        ...
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetCombinedData?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['text'])) {
        $file = file_get_contents($post_data['args']['text']);
        $body['text'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/text/TextGetCombinedData?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['extract'])) {
        $body['extract'] = urlencode($post_data['args']['extract']);
    }
