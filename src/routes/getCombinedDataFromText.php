...
$app->post('/api/AlchemyText/getCombinedDataFromText', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['extract'])) {
        $body['extract'] = is_array($post_data['args']['extract'])? implode("|", $post_data['args']['extract']): $post_data['args']['extract'];
    }
