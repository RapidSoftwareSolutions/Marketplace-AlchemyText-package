...
$app->post('/api/AlchemyText/getEmotion', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['text'])) {
        ...
        $body['text'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/text/TextGetEmotion?apikey='.$post_data['args']['apiKey'];
    }
