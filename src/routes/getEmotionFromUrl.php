...
$app->post('/api/AlchemyText/getEmotionFromUrl', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['url'])) {
        ...
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetEmotion?apikey='.$post_data['args']['apiKey'];
    }
