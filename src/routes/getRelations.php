...
$app->post('/api/AlchemyText/getRelations', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['html'])) {
        ...
        $body['html'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/html/HTMLGetRelations?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['url'])) {
        $body['url'] = $post_data['args']['url'];
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetRelations?apikey='.$post_data['args']['apiKey'];
    }
    ...
    if(!empty($post_data['args']['keywords'])) { //HTML, URL, TEXT
        $body['keywords'] = $post_data['args']['keywords'];
    }
    if(!empty($post_data['args']['entities'])) { //HTML, URL, TEXT
        $body['entities'] = $post_data['args']['entities'];
    }
    if(!empty($post_data['args']['requireEntities'])) { //HTML, URL, TEXT
    ...
    if(!empty($post_data['args']['sentimentExcludeEntities'])) { //HTML, URL, TEXT
