...
$app->post('/api/AlchemyText/getTargetedEmotion', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['url'])) {
        ...
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetTargetedEmotion?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['text'])) {
        $body['text'] = $post_data['args']['text'];
        $query_str = 'https://gateway-a.watsonplatform.net/calls/text/TextGetTargetedEmotion?apikey='.$post_data['args']['apiKey'];
    }
