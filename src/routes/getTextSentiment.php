...
$app->post('/api/AlchemyText/getTextSentiment', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['html'])) {
        ...
        $body['html'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/html/HTMLGetTextSentiment?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['url'])) {
        $body['url'] = $post_data['args']['url'];
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetTextSentiment?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['text'])) {
        $file = file_get_contents($post_data['args']['text']);
        $body['text'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment?apikey='.$post_data['args']['apiKey'];
    }
