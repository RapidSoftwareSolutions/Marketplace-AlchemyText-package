...
$app->post('/api/AlchemyText/getTitle', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['html'])) {
        ...
        $body['html'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/html/HTMLGetTitle?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['url'])) {
        $body['url'] = $post_data['args']['url'];
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetTitle?apikey='.$post_data['args']['apiKey'];
    }
    
    if(!empty($post_data['args']['urlForResponse'])) { //HTML, TEXT
        $body['url'] = $post_data['args']['urlForResponse'];
    }
    if(isset($post_data['args']['useMetadata']) && $post_data['args']['useMetadata']=='') { //HTML, URL, TEXT
