...
$app->post('/api/AlchemyText/getTypedRelations', function ($request, $response, $args) {
    ...
    if(!empty($post_data['args']['html'])) {
        ...
        $body['html'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/html/HTMLGetTypedRelations?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['url'])) {
        $body['url'] = $post_data['args']['url'];
        $query_str = 'https://gateway-a.watsonplatform.net/calls/url/URLGetTypedRelations?apikey='.$post_data['args']['apiKey'];
    }
    if(!empty($post_data['args']['text'])) {
        $file = file_get_contents($post_data['args']['text']);
        $body['text'] = $file;
        $query_str = 'https://gateway-a.watsonplatform.net/calls/text/TextGetTypedRelations?apikey='.$post_data['args']['apiKey'];
    }
    ...
    if(!empty($post_data['args']['model'])) { //HTML, URL, TEXT
        $body['model'] = $post_data['args']['model'];
    }
